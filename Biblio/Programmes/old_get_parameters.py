...
path_folder = "/home/rblin/Documents/BD_test"

imgs_polar = sorted(os.listdir(path_folder))
# imgs_polar.remove(".DS_Store")

for k in range(len(imgs_polar)):#3352, len(imgs_polar)):
    ...
    path_traitement = "/home/rblin/Documents/Database_ITSC_correction/"

    # Caméra polarimétrique
    imageio.imwrite(path_traitement + "I/" + str(k-1) + "_P0.png", P0)
    imageio.imwrite(path_traitement + "I/" + str(k-1) + "_P45.png", P45)
    imageio.imwrite(path_traitement + "I/" + str(k-1) + "_P90.png", P90)
    ...
    AOP = 0.5*np.arctan2(Stokes[2], Stokes[1])
